...
const questions = [{
    ...
    //     message: 'What is the first name of the new manager being added?',
    //     when: ({
    //         promptQuestions
    //     }) => {
    //         if (promptQuestions === 'Add a Manager') {
    //             return true;
    //         } else {
    //             return false;
    //         }
    //     },
    //     validate: newManagerFirstNameInput => {
    //         if (newManagerFirstNameInput) {
    //             return true;
    //         } else {
    //             console.log('Please enter a first name for the new manager!');
    //             return false;
    //         }
    //     },
    // },
    ...
    //     message: 'What is the last name of the new manager being added?',
    //     when: ({
    //         newManagerFirstName
    //     }) => {
    //         if (newManagerFirstName) {
    //             return true;
    //         } else {
    //             return false;
    //         }
    //     },
    //     validate: newManagerLastNameInput => {
    //         if (newManagerLastNameInput) {
    //             return true;
    //         } else {
    //             console.log('Please enter a last name for the new manager!');
    //             return false;
    //         }
    //     },
    // },
    // {
    //     type: 'number',
    //     name: 'newManagerRoleId',
    //     message: 'What is the role ID of the new manager being added?',
    //     when: ({
    //         newManagerLastName
    //     }) => {
    //         if (newManagerLastName) {
    //             return true;
    //         } else {
    //             return false;
    //         }
    //     },
    //     validate: newManagerRoleIdInput => {
    //         if (newManagerRoleIdInput) {
    //             return true;
    //         } else {
    //             console.log('Please enter a role ID for the new manager!');
    //             return false;
    //         }
    //     }
    // },
