...
const questions = [{
    ...
    },
    {
        ...
        validate: newEmployeeManagerIdInput => {
            if (newEmployeeManagerIdInput) {
                return true;
            } else {
                console.log('Please enter a manager ID for the new employee!');
                return false;
            }
        }
    },
    ...
    },
    {
        ...
        validate: updateEmployeeManagerIdInput => {
            if (updateEmployeeManagerIdInput) {
                ...
                console.log('Please enter the new manager ID for the employee being updated!');
                return false;
            }
        }
    },
